...
export const userInvitations: UserInvitationData[] = [
  {
    ...
    metaTitle: "Maximiliano cumple 2 años | Safari Dreams",
    metaDescription:
      "Acompáñanos a celebrar los 2 años de Maximiliano en una aventura llena de magia y alegría.",
    celebrantName: "Maximiliano",
    age: 2,
