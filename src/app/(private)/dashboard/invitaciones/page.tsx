...
// Fake data - TODO: Reemplazar con datos reales de Supabase
...
const themeColors: Record<string, string> = {
  ...
  Dinosaurio: "bg-orange-100 text-orange-800",
  Espacial: "bg-blue-100 text-blue-800",
};

export default function InvitacionesPage() {
  const [invitations] = useState(fakeInvitations);
              ...
              <div className="p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="mb-2 flex flex-wrap items-center gap-2">
                      ...
                      <span
                        className={`rounded-full px-3 py-1 text-xs font-medium ${
                          themeColors[invitation.theme] || "bg-gray-100 text-gray-800"
                        }`}
                      >
                        {invitation.theme}
                      </span>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button className="inline-flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
                      <svg
                        className="h-4 w-4"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <button className="inline-flex items-center gap-2 rounded-lg border border-red-300 px-4 py-2 text-sm font-medium text-red-700 transition hover:bg-red-50">
                      <svg
                        className="h-4 w-4"
                        fill="none"
                        viewBox="0 0 24 24"
