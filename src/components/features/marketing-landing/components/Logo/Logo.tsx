  ...
  return (
    <div className={`flex items-center gap-2 md:gap-3 ${className}`}>
      <svg
        ...
        className="h-10 w-10 flex-shrink-0 md:h-[50px] md:w-[50px]"
      >
        <circle cx="100" cy="80" r="45" fill="#E63946" opacity="0.9" />
        <circle cx="65" cy="110" r="45" fill="#F77F00" opacity="0.9" />
        <circle cx="135" cy="110" r="45" fill="#4ECDC4" opacity="0.9" />
